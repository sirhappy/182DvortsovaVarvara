...
Если числа могут быть длинами сторон треугольника - вычислить его
площадь по формуле Герона.
Написать метод, вычисляющий площадь (s) и периметр (p)
треугольника по заданным длинам его сторон. Метод должен
возвращать значение false, если параметры заданы неверно и
треугольник с такими длинами построить нельзя. При удачном
задании длин сторон метод возвращает true.*/
namespace Task1
{
	class Program
	{
