namespace Task6
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Разместить цифры по убыванию";
			...
			this.textBox1.Location = new System.Drawing.Point(134, 161);
			...
			this.Text = "Упорядочить по убыванию цифры натурального числа";
